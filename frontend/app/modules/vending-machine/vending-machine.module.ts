...
@NgModule({
    imports: [SharedModule, SharedComponentModule, VendingMachineRoutingModule ,SearchVendingMachineModule],
    declarations: [ VendingMachineComponent ],
    exports: [ SearchVendingMachineModule, VendingMachineComponent]
})
